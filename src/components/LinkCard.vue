...
<template>
  ...
  >
    <!-- Icon Container -->
    <div
      class="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-gray-700 text-pink-400 group-hover:scale-110 group-hover:bg-pink-500 group-hover:text-white group-hover:shadow-xl group-hover:shadow-pink-500/20"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
    ...
    <!-- Hover Glow Effect -->
    <div
      class="absolute inset-0 rounded-xl bg-linear-to-r from-green-500/0 via-pink-500/10 to-pink-500/0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
    />
  </a>
</template>
